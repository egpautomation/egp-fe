...
export default function SORJsonImport({ setReload, isJSONImportOpen }: { setReload: () => void; isJSONImportOpen: boolean }) {
...
setReload(prev => prev + 1);
  ...
  return (
   <div>
    {isJSONImportOpen &&  <div className="rounded-2xl border border-dashed border-indigo-300 bg-indigo-50/60 p-5">
