    ...
    <section className="w-full">
      <div className="mx-auto py-10 lg:py-16">
        <div className="text-center">
          ...
          <p className="mt-2">প্রতিটি সার্ভিসের সংক্ষিপ্ত বর্ণনা নিচে দেওয়া হলো।</p>
        </div>
              ...
              <tbody className="divide-y divide-slate-100">
                {services.map((service) => (
                  <tr key={service.title}>
                    <td className="px-4 py-4 text-gray-700">{service.title}</td>
                    <td className="px-4 py-4 text-gray-600">{service.description}</td>
                  </tr>
                ))}
              </tbody>
            </table>
