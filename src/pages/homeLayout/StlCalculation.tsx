      ...
      <div className="container h-full mx-auto lg:px-10 px-4 py-10 lg:py-16">
        <section className="max-w-4xl mx-auto text-center mb-10">
          ...
          <p className="mt-3 text-base text-gray-600 animate-slide-up" style={{ animationDelay: "100ms" }}>
            দায়স্বীকার (Disclaimer): নিম্নে NPPI ফ্যাক্টর ও সংশ্লিষ্ট তথ্যসমূহ ডাটাবেইজে সংরক্ষিত পূর্ববর্তী উপাত্তের ভিত্তিতে আনুমানিকভাবে নির্ধারণ করা হয়েছে। এটি কোনো নির্দিষ্ট eGP ভ্যালুর সাথে সম্পূর্ণ সামঞ্জস্যপূর্ণ হবে—এমন নিশ্চয়তা প্রদান করে না। প্রকৃত NPPI মান অধিদপ্তর, কাজের ধরন, কাজের লোকেশন, ক্রয় পদ্ধতি, ক্রয়ের ধরণ এবং পূর্ববর্তী কার্যাদেশের মূল্যের উপর নির্ভর করে Central Procurement Technical Unit (CPTU) কর্তৃক নির্ধারিত হয়ে থাকে। অতএব, প্রদর্শিত তথ্যসমূহ কেবলমাত্র ধারণা প্রদানের উদ্দেশ্যে উপস্থাপিত এবং চূড়ান্ত বা বাধ্যতামূলক মান হিসেবে গণ্য করা যাবে না।
          </p>
        </section>
