  ...
  const features = [
    {
      ...
      description:
        "অটোমেটিক ফর্ম ফিল-আপ এবং ডকুমেন্ট জেনারেশন। BOQ প্রস্তুতি, ক্যাপাসিটি হিসাব এবং সব ধরনের টেন্ডার ডকুমেন্ট এক ক্লিকে তৈরি করুন।",
    },
    {
      icon: FiZap,
      title: "দ্রুত টেন্ডার সাবমিশন",
      description:
        "LTM, OTM, OSTEM টেন্ডার অটো ড্রপ সুবিধা। সরকারি e-GP পোর্টালে সরাসরি সাবমিট করুন মাত্র কয়েক সেকেন্ডে।",
    },
    {
      icon: FiTrendingUp,
      title: "রেট অ্যানালাইসিস",
      description:
        "বুদ্ধিমান রেট বিশ্লেষণ সিস্টেম। বাজার দর, প্রতিযোগীদের রেট এবং আপনার ক্যাপাসিটি বিবেচনা করে সঠিক দর নির্ধারণ করুন।",
    },
    {
      icon: FiClock,
      title: "সময় সাশ্রয়",
      description:
        "টেন্ডার প্রস্তুতির ৯৫% সময় বাঁচান। ম্যানুয়াল কাজের পরিবর্তে অটোমেশন ব্যবহার করে দ্রুত কাজ সম্পন্ন করুন।",
    },
    {
      icon: FiShield,
      title: "নির্ভুলতা নিশ্চিত",
      description:
        "ম্যানুয়াল ভুল থেকে মুক্তি। অটোমেটেড সিস্টেম নিশ্চিত করে যে আপনার সব ডকুমেন্ট সঠিক এবং পেশাদার।",
    },
    {
      icon: FiUsers,
      title: "একাধিক কোম্পানি ম্যানেজমেন্ট",
      description:
        "একটি অ্যাকাউন্ট থেকে একাধিক কোম্পানি ম্যানেজ করুন। আলাদা আলাদা লগইনের প্রয়োজন নেই।",
    },
  ];
  ...
  const steps = [
    {
      ...
      description:
        "সহজ রেজিস্ট্রেশন প্রক্রিয়ার মাধ্যমে আপনার অ্যাকাউন্ট তৈরি করুন। মাত্র কয়েক মিনিটেই সম্পন্ন হবে।",
      icon: FiCheckCircle,
    },
    {
      number: "০২",
    ...
    },
    {
      ...
      description:
        "আপনার ব্যবসার উপযোগী টেন্ডার খুঁজুন। বিভাগ, ক্যাটাগরি বা জেলা অনুযায়ী ফিল্টার করুন।",
      icon: FiTrendingUp,
    },
    {
      number: "০৪",
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <h2 className="mt-4 text-gray-900">আমরা কী করি?</h2>
            <p className="mt-4 text-lg text-gray-600">
              ই-টেন্ডার বিডি ঠিকাদারদের জন্য একটি সম্পূর্ণ অটোমেটেড প্ল্যাটফর্ম। টেন্ডার আবিষ্কার
              থেকে শুরু করে ডকুমেন্ট প্রস্তুতি এবং সাবমিশন — সবকিছু এক জায়গায়।
            </p>
          </div>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-[#4874c7]/5 via-white to-[#4874c7]/10">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <p className="text-sm font-semibold uppercase tracking-wide text-[#4874c7]">সহজ ধাপ</p>
            <h2 className="mt-4 text-gray-900">কীভাবে ব্যবহার করবেন?</h2>
            <p className="mt-4 text-lg text-gray-600">
                  ...
                  >
                    ...
                    <div className="flex-1 pt-2">
                      <div className="flex items-center gap-3 mb-2">
                        <span className="text-2xl font-bold text-[#4874c7]/30">{step.number}</span>
                      </div>
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <h2 className="mt-4 text-gray-900">আপনার সুবিধা</h2>
            <p className="mt-4 text-lg text-gray-600">
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-r from-[#4874c7] to-[#3a5da8]">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-white mb-6">আজই শুরু করুন আপনার টেন্ডার সফলতার যাত্রা</h2>
            <p className="text-lg text-white/90 mb-8">
              সরকারি টেন্ডারে অংশগ্রহণ করা এখন আরও সহজ। ই-টেন্ডার বিডি আপনার প্রতিটি ধাপে সাথে আছে।
            </p>
