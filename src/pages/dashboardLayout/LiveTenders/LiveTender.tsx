...
export default function LiveTender() {
  ...
  const [publishingDateSearch, setPublishingDateSearch] = useState(
    searchParams.get("publishingDate") || ""
  );
  const [debouncedPublishingDateSearch, setDebouncedPublishingDateSearch] =
    useState(publishingDateSearch);
        ...
        <div className="flex flex-wrap items-center gap-2">
          {publishingDateSearch && (
            <div className="flex items-center gap-2 bg-primary/10 text-primary text-sm font-semibold px-3 py-1.5 rounded-xl border border-primary/20">
              ...
              <button
                onClick={() => setPublishingDateSearch("")}
                className="hover:text-red-500 hover:bg-red-50 p-0.5 rounded-full transition ml-1"
      ...
      <div className="mb-4 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-2">
        <div className="relative">
          ...
          <Input
            ...
            onChange={(e) => {
              setTenderIdSearch(e.target.value);
              setCurrentPage(1);
            }}
        ...
        <Input
          ...
          onChange={(e) => {
            setTypeMethodSearch(e.target.value);
            setCurrentPage(1);
          }}
