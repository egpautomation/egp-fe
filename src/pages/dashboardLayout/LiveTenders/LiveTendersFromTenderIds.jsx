...
export default function LiveTendersFromTenderIds() {
  ...
  const { allTenders, tenders, loading, tendersCount, setReload } = useLiveTenders(
    debouncedSearch,
    "",
    "",
    "",
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-5">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <Button
            ...
            variant="outline"
            className="h-9 text-sm gap-1.5 bg-emerald-50 border-emerald-200 text-emerald-700 hover:bg-emerald-100"
          >
            <Download size={14} />
            Download IDs
          </Button>
