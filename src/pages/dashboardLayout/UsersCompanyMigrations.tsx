                ...
                filteredData?.map((item, idx) => (
                  <tr key={idx} className={`border ${idx % 2 == 1 && "bg-gray-100"}`}>
                    ...
                    <td className="px-4 py-2 flex items-center justify-center gap-2">
                      <Link to={`/dashboard/edit-company-registration/${item?._id}`} title="Edit">
                        <SquarePen
          ...
          <div className="flex items-center justify-between gap-2 mt-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                ...
                className={
                  item?.status?.toLowerCase() !== "active" ? "pointer-events-none opacity-50" : ""
                }
              >
                <FilePenLine
                  size={22}
                  className={
                    item?.status?.toLowerCase() === "active" ? "text-blue-600" : "text-gray-400"
                  }
                />
              </Link>
              <DeleteDataModal
