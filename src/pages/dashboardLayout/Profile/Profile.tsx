...
import { User, Mail, Phone, Calendar, Loader2, MapPin, MessageCircle, Wallet, Edit, Save, Camera } from "lucide-react";
                        ...
                        <div className="flex gap-4 items-start">
                            ...
                            <div>
                                ...
                                {profileData.district && (
                                    <p className="text-sm text-slate-600 mt-1 font-medium">District: <span className="text-slate-800">{profileData.district}</span></p>
                                )}
                            </div>
                        </div>
            ...
            <Dialog open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
                <DialogContent className="sm:max-w-[500px] p-0 overflow-hidden border-none shadow-2xl">
                    <DialogHeader className="bg-primary p-6 text-white text-left">
                        ...
                        <p className="text-primary-foreground/80 text-sm mt-1">Update your personal details below. Your email and role cannot be changed.</p>
                    </DialogHeader>
                    ...
                    <form onSubmit={handleUpdateProfile} className="p-6 space-y-5">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="district" className="text-slate-700 font-semibold">District</Label>
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="profile" className="text-slate-700 font-semibold flex items-center gap-2">
                            ...
                            <Input
                                ...
                                className="border-slate-200 focus:border-primary focus:ring-primary/20"
                            />
                            <p className="text-[10px] text-slate-500 italic">Provide a direct link to your profile picture.</p>
                        </div>
