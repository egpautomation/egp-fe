  ...
  return (
    <div className="container max-w-4xl mx-auto  my-10  bg-white">
      <div className="flex justify-end mb-4 no-print">
        <Button onClick={() => handleDownloadManufacturerAuthorization(companyData, currentTender)}>
          Download PDF
        </Button>
      </div>
      ...
      <div className="border p-10 mt-5" id="print-area">
        ...
        <div>
          <div className="mb-4 mt-4 text-justify ">
            <p className="text-justify text-black">WHEREAS</p>
            <br />
            <p className=" text-black">We [insert complete name of Manufacturer],</p>
          </div>

          <div className="mb-4  text-justify">
            <p className="text-justify text-black">
              who are official manufacturers of [insert type of goods manufactured], having
              factories at [insert full address of Manufacturer’s factories], do hereby
            </p>
          </div>

          <div className="mt-8  text-justify">
            <p className="text-justify text-black">
              authorize [insert complete name of Tenderer] to supply the following Goods,
          ...
          <div className="mt-8  text-justify">
            <p className="text-justify text-black">
              ...
              General Conditions of Contract, with respect to the Goods offered by the above
              Tenderer.
            </p>
          </div>
          <div className="mt-8  text-justify">
            ...
            <p className=" text-black">Address: [insert full address including Fax and e-mail]</p>
            <p className=" text-black">Address: [insert full address including Fax and e-mail]</p>
            <p className=" text-black">Title: [insert title]</p>
            <p className=" text-black">Date: [insert date of signing]</p>
          </div>
        </div>
      </div>
    </div>
