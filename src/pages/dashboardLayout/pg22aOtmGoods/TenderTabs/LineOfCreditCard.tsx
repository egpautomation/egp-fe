...
export default function LineOfCreditCard({
  tenderId,
  egpEmail,
  currentTender,
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                ...
                <Link target="_blank" to={`/line-of-credit/${tenderId}?egpEmail=${egpEmail}`}>
                  View{" "}
                </Link>
              </Button>
            </div>
          ...
          <div className="">
            <div className="bg-white p-8 ">
              ...
              <div className="mb-4">
                ...
                <p>
                  To:{" "}
                  {currentTender?.officialDesignation
                    ? `${currentTender?.officialDesignation},${(<br />)}`
                    : ""}{" "}
                  {currentTender?.procuringEntityName
                    ? currentTender?.procuringEntityName
                    : currentTender?.division || "N/A"}
                  , <br />
                  {currentTender?.locationDistrict ? currentTender?.locationDistrict : "N/A"} <br />
                </p>
              </div>
              ...
              <div className="mb-4  text-justify">
                <p className="text-justify">
                  ...
                  <span className="font-bold">
                    {currentTender?.liquidAssets || "[in figure]"} (
                    {numberToWords(currentTender?.liquidAssets)})
                  </span>{" "}
