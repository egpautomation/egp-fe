...
export default function ManufacturerAuthorizationCard({tenderId, egpEmail, currentTender}: authorizationCardProps) {
    ...
    <Card className="hover:shadow-lg transition-shadow">
                    <CardHeader>
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <CardTitle>Manufacturer&nbsp;s Authorization Letter</CardTitle>
                    ...
                    <CardContent>
                        <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <Button
                                   onClick={()=>handleDownloadManufacturerAuthorization(companyData, currentTender)}
                                ...
                                >
                                    ...
                                    <Link target='_blank' to={`/manufacturer-authorization/${tenderId}?egpEmail=${egpEmail}`}>View </Link>
                                </Button>
                            </div>
                        </div>
                    </CardContent>
