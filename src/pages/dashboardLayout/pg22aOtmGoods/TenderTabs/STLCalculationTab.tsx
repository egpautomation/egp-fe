...
export const STLCalculationTab = () => {
  ...
  const handlePdfUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const errorMsg =
        serverData?.message || serverData?.error || error.message || "Error processing PDF";
        ...
        <CardContent className="p-3 sm:p-4 md:p-6 space-y-6">
          <div className="p-5 rounded-2xl border border-blue-100 bg-linear-to-br from-blue-50/80 to-indigo-50/50 backdrop-blur-sm flex items-start gap-4 text-left shadow-sm">
            ...
            <p className="text-sm sm:text-base leading-relaxed text-slate-700">
              ...
              নিম্নে NPPI ফ্যাক্টর ও সংশ্লিষ্ট তথ্যসমূহ ডাটাবেইজে সংরক্ষিত পূর্ববর্তী উপাত্তের
              ভিত্তিতে আনুমানিকভাবে নির্ধারণ করা হয়েছে। এটি কোনো নির্দিষ্ট eGP ভ্যালুর সাথে
              সম্পূর্ণ সামঞ্জস্যপূর্ণ হবে—এমন নিশ্চয়তা প্রদান করে না। প্রকৃত NPPI মান অধিদপ্তর,
              কাজের ধরন, কাজের লোকেশন, ক্রয় পদ্ধতি, ক্রয়ের ধরণ এবং পূর্ববর্তী কার্যাদেশের মূল্যের
              উপর নির্ভর করে Central Procurement Technical Unit (CPTU) কর্তৃক নির্ধারিত হয়ে থাকে।
              অতএব, প্রদর্শিত তথ্যসমূহ কেবলমাত্র ধারণা প্রদানের উদ্দেশ্যে উপস্থাপিত এবং চূড়ান্ত বা
              বাধ্যতামূলক মান হিসেবে গণ্য করা যাবে না।
            </p>
          </div>
          {/* Input Section */}
          ...
          <div className="space-y-4 p-3 sm:p-4 bg-blue-50 rounded-lg border border-blue-200">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Upload a PDF file containing bidder names and prices. The system will automatically
            ...
            <div className="border rounded-lg overflow-x-auto">
              <table className="w-full min-w-[700px] text-sm">
                <thead className="bg-gray-50 border-b">
                  <tr>
                    <th className="text-left p-3 font-semibold text-gray-700 text-xs w-[22%]">
                      Name of Tenderer
                    </th>
                    <th className="text-left p-3 font-semibold text-gray-700 text-xs w-[15%]">
                      Quoted Price (Xi)
                    </th>
                    <th className="text-center p-3 font-semibold text-gray-700 text-xs w-[9%]">
                      Δ%
                    </th>
                    <th className="text-center p-3 font-semibold text-gray-700 text-xs w-[16%]">
                      Primary Resp.
                    </th>
                    <th className="text-center p-3 font-semibold text-gray-700 text-xs w-[16%]">
                      Financial Resp.
                    </th>
                    <th className="text-center p-3 font-semibold text-gray-700 text-xs w-[10%]">
                      Rank
                    </th>
                    <th className="text-center p-3 font-semibold text-gray-700 text-xs w-[12%]">
                      Action
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y">
                  {bidders.map((bidder, index) => {
                    const stats =
                      results && "bidderStats" in results ? results.bidderStats[index] : null;
                    return (
                      <tr key={index} className="hover:bg-gray-50 transition-colors">
                        <td className="p-2">
                          <Input
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                              updateBidder(index, "name", e.target.value)
                            }
                        ...
                        <td className="p-2">
                          <Input
                            ...
                            value={bidder.price}
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                              updateBidder(index, "price", e.target.value)
                            }
                            placeholder="Price"
                            className="w-full"
                          />
                            ...
                            <div className="flex items-center gap-2">
                              <Checkbox
                                ...
                                onCheckedChange={(checked) =>
                                  updateBidder(index, "qualified", checked)
                                }
                              />
                              <Label htmlFor={`q-${index}`} className="text-[10px] cursor-pointer">
                                Technical
                              </Label>
                            </div>
                            {stats?.isAbove110 && (
                              <span className="text-[10px] text-red-600 font-bold bg-red-50 px-1 rounded whitespace-nowrap">
                                &gt; 10% OCE
                              </span>
                            )}
                          </div>
                        ...
                        <td className="p-2 text-center">
                          {stats ? (
                            <span
                              className={`text-[10px] font-bold px-2 py-1 rounded whitespace-nowrap ${stats.isResponsive ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                            >
                              {stats.isResponsive ? "Responsive" : "Non-Responsive"}
                            </span>
                          ) : (
                ...
                <div className="max-w-4xl mx-auto space-y-4">
                        ...
                        <tbody>
                          <tr className="border-b border-gray-100">
                            ...
                            <td className="py-3 px-4 text-sm text-gray-600">
                              Official Approved Cost Estimate
                            </td>
                          </tr>
                          <tr>
                  ...
                  <div className="bg-white rounded-lg border border-gray-300">
                    ...
                    <div className="p-4 text-center">
                      <p className="text-lg font-semibold text-gray-800">{results.winner}</p>
