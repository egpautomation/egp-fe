    ...
    return (
        ...
        >
            ...
            <td className={`px-4 py-2 `}>
                <span className={`inline-block  px-2 rounded ${item?.status == "active" && "bg-green-700 text-white"} ${item?.status == "inactive" && "bg-red-700 text-white"}  ${item?.status == "inactive" && "bg-gray-700 text-white"}`}>{item?.status || "Not Registered"} </span>
            </td>
