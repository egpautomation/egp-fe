        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-semibold mb-1">
              {tendersCount} {method && `${method}`} Tenders Found That Need To
              Update
            </h1>
          </div>
        </div>
                ...
                ? tenders?.map((item, idx) => (
                  ...
                  >
                    <td className="px-4 py-2 align-top">
                      <Link to={`/public/find-tender-subCategory/${item?.tenderId}`}> <Button className="cursor-pointer">Find Sub Categories</Button></Link>
                      {/* <TenderExtractor setReload={setReload} data={item} /> */}
                    </td>
                    <td className="px-4 py-2 align-top">{item?.tenderId}</td>

                    <td className="px-4 py-2 align-top min-w-48">
                      {item?.tenderCategory}
                    </td>
