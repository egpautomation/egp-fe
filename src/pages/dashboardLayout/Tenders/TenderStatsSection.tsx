    ...
    <div>
      <div className="grid grid-cols-3 gap-5 py-5 items-center">
        <div className="col-span-3 md:col-span-2 p-3 md:p-5">
          <h1 className="text-2xl font-semibold">Welcome To Egp Tender Automation</h1>
          <p className="mt-3 text-sm">
            বর্তমান সময়ে সরকারি টেন্ডার প্রক্রিয়া বিশেষ করে এলটিএম (LTM) টেন্ডারগুলোতে অংশগ্রহণ
            করা যেমন সময়সাপেক্ষ, তেমনি তথ্য উপস্থাপনের ঝামেলাও অনেক। এই পুরো প্রক্রিয়াকে সহজ ও
            দ্রুত করতে আমরা এনেছি "LTM টেন্ডার প্রসেসিং অটোমেশন সার্ভিস" – যেখানে শুধুমাত্র
            প্রয়োজনীয় তথ্য প্রদান করলেই সফটওয়্যার স্বয়ংক্রিয়ভাবে আপনার টেন্ডার ফরম পূরণ করবে,
            অর্ডার সাবমিট করবে এবং আপনাকে আপডেট জানাবে।
          </p>
          <p className="mt-3 text-sm">
            এই সার্ভিসটি মূলত তাদের জন্য যারা প্রতিদিনের ই-জিপি টেন্ডার প্রক্রিয়ার ভেতরেই কাজ করে,
            কিন্তু সময়, দক্ষ লোকবল বা প্রক্রিয়াজনিত জটিলতার কারণে বারবার সমস্যায় পড়েন। আমাদের এই
