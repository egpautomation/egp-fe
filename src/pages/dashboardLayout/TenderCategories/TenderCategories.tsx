...
const TenderCategories = () => {
  ...
  const [pageLimit, setPageLimit] = useState(Number(searchParams.get("limit")) || 50);
  ...
  const {
    ...
    setReload,
    count,
  } = useAllTenderCategoriesWithPagination(searchTerm, currentPage, pageLimit);
          ...
          <table id="tender_categories_table" className="mt-5 w-full">
            <thead>
              <tr className="bg-primary text-primary-foreground">
                <th className="whitespace-nowrap px-4 py-2 text-start rounded-tl">Category Id</th>
                <th className="whitespace-nowrap px-4 py-2 text-start">Category Name</th>
                <th className="whitespace-nowrap px-4 py-2 text-start ">Sub Category</th>
                <th className="whitespace-nowrap px-4 py-2 text-start ">Action</th>
              </tr>
            </thead>
