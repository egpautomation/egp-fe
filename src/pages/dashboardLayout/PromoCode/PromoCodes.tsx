    ...
    <div>
      <div className="flex justify-between mt-5">
        <div className="flex items-center gap-2">
          <AlignJustify />
          <h1 className="text-2xl font-semibold mb-1">Promo Codes List</h1>
        </div>
        <div className="flex items-center justify-center gap-2">
          <Link className=" inline-block" to={"/dashboard/create-promo-code"}>
          ...
          <table className="mt-5 w-full">
            <thead>
              <tr className="bg-primary text-primary-foreground">
                <th className="whitespace-nowrap px-4 py-2 text-start rounded-tl">Name</th>
                <th className="whitespace-nowrap px-4 py-2 text-start">Code</th>
                <th className="whitespace-nowrap px-4 py-2 text-start ">Percentage</th>
                <th className="whitespace-nowrap px-4 py-2  text-start">Deadline</th>
                <th className="whitespace-nowrap px-4 py-2 text-start ">Validate</th>
